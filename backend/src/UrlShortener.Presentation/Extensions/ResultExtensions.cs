...
internal static class ResultExtensions {
    ...
    public static IResult ToIResult(this Result result) => result.IsSuccess ? Results.Ok(result) : Results.Json(result, statusCode: result.Errors.Select(x => x.StatusCode).Max());
